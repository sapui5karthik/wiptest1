		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "WipTest1",
									"targetURL": "#comchapotawiptest1projectwiptest1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchapotawiptest1projectwiptest1-display": {
								"semanticObject": "comchapotawiptest1projectwiptest1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.chapota.wiptest1.projectwiptest1",
									"url": sap.ui.require.toUrl("com/chapota/wiptest1/projectwiptest1")
								}
							}
						}
					}
